...
ProjectPath            := "F:\南京师范大学\计算机学院\Algorithms\Algorithms\construction_of_a_graph"
...
$(IntermediateDirectory)/dfs.cpp$(ObjectSuffix): dfs.cpp $(IntermediateDirectory)/dfs.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "F:/南京师范大学/计算机学院/Algorithms/Algorithms/construction_of_a_graph/dfs.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/dfs.cpp$(ObjectSuffix) $(IncludePath)
